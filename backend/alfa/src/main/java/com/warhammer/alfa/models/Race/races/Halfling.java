...
public class Halfling extends Race {
    public Halfling(SkillRepository skillRepository, TalentRepository talentRepository) {
        super(
            RaceEnum.HALFLING,
            "race.halfling.name",
            "race.halfling.description",
            "race.halfling.background",
            "race.halfling.roleplayingHints",
            skillRepository,
            talentRepository
        );
    ...
    private void initializeCharacteristicModifiers() {
        ...
        characteristicModifiers.put(CharacteristicEnum.WEAPON_SKILL, 10); // + 2d10
        characteristicModifiers.put(CharacteristicEnum.BALLISTIC_SKILL, 30); // + 2d10
        characteristicModifiers.put(CharacteristicEnum.STRENGTH, 10); // + 2d10
        characteristicModifiers.put(CharacteristicEnum.TOUGHNESS, 10); // + 2d10
        ...
        characteristicModifiers.put(CharacteristicEnum.FELLOWSHIP, 30); // + 2d10
    ...
    private void initializeSkills() {
        ...
        skills.add(skillRepository.findByName("skill.speak_language.name")); // Halfling
    ...
    private void initializeTalents() {
        ...
        talents.add(talentRepository.findByName("talent.resistance_to_chaos.name"));
        talents.add(talentRepository.findByName("talent.specialist_weapon_group.name")); // Sling
    }
